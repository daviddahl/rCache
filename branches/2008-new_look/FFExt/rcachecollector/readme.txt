...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\rcachecollector on
     Windows, /home/user/dev/rcachecollector on Linux) in a file named
     ffext@rcache.com and copy that file to
